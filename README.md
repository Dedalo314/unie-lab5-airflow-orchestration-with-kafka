...
.
├── src/
│   ├── producer_dag.py   # Airflow DAG: Produces mock events to Kafka
│   └── consumer_dag.py   # Airflow DAG: Consumes and branches based on event data
├── compose.yaml          # Multi-container setup (Airflow, Kafka, Zookeeper, Postgres)
